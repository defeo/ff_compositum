...
\newfont{\mycrnotice}{ptmr8t at 7pt} %DO NOT CHNAGE
\newfont{\myconfname}{ptmri8t at 7pt} %DO NOT CHNAGE
\let\crnotice\mycrnotice  %%DO NOT CHNAGE
\let\confname\myconfname  %%DO NOT CHNAGE
\permission{Permission to make digital or hard copies of all or part of this work for personal or classroom use is granted without fee provided that copies are not made or distributed for profit or commercial advantage and that copies bear this notice and the full citation on the first page. Copyrights for components of this work owned by others than the author(s) must be honored. Abstracting with credit is permitted. To copy otherwise, or republish, to post on servers or to redistribute to lists, requires prior specific permission and/or a fee. Request permissions from Permissions@acm.org.}
\conferenceinfo{ISSAC'14,}{July 23--25, 2014, Kobe, Japan. \\Copyright is held by the owner/author(s). Publication rights licensed to ACM.}
\crdata{978-1-4503-2501-1/14/07\ ...\$15.00.\\
http://dx.doi.org/10.1145/2608628.2608672 }
\clubpenalty=10000 %DO NOT CHNAGE
\widowpenalty = 10000 %DO NOT CHNAGE
...
\smallskip\noindent{\bf Outline.}  Section~\ref{sec:prelim} presents
...
\begin{Lemma}
  ...
  computes the coefficients of $\Phi^{-1}(a)$ in the basis $\bxi^\ast
  \otimes \bupsilon$ using $O(m^2\M(n))$ operations in~$k$.
\end{Lemma}
\begin{proof}
...
%\smallskip
\noindent{\bf Acknowledgements.} We would like to thank the referees
